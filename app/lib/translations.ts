...
export const translations: Record<Language, Translations> = {
  nl: {
    ...
    fundReception: {
      ...
      successText: 'Een agent DSVV Dienst zal contact met u opnemen via WhatsApp. Gelieve het nodige te doen om uw geld vandaag nog te ontvangen via onmiddellijke overschrijving.',
  ...
  fr: {
    ...
    fundReception: {
      ...
      successText: 'Un agent DSVV Dienst vous contactera via WhatsApp. Veuillez faire le nécessaire pour recevoir votre argent dès aujourd\'hui par virement immédiat.',
      successThanks: 'Merci',
      closeButton: 'Fermer',
    },
    footer: {
